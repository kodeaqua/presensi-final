                                                    ...
                                                    <div class="">
                                                        <div class="mb-1">
                                                            ...
                                                            <input type="text"
                                                                ...
                                                                name="nisn" id="nisn" aria-describedby="nisn"
                                                                value="{{ old('nisn') }}" required autocomplete="nisn"
                                                                autofocus placeholder="Contoh: xxxxxxx" />
                                                        </div>
                                                        <div class="mb-1">
                                                            <label class="form-label" for="nis">NIS</label>
                                                            <input type="text"
                                                                class="form-control @error('nis') is-invalid @enderror"
                                                                name="nis" id="nis" aria-describedby="nis"
                                                                value="{{ old('nis') }}" required autocomplete="nis"
                                                                autofocus placeholder="Contoh: 021014001" />
                                                        </div>
                                                        <div class="mb-1">
                                                            <label class="form-label" for="student">Nama Siswa</label>
                                                            <input type="text"
                                                                class="form-control @error('student') is-invalid @enderror"
                                                                name="student" id="student" aria-describedby="student"
                                                                value="{{ old('student') }}" required autocomplete="student"
                                                                autofocus placeholder="Contoh: Adam Najmi Zidan" />
                                                        </div>
                                                        <div class="mb-1">
                            ...
                            <table class="table mb-0">
                                <thead>
                                    <tr class="text-center">
                                        ...
                                        <th scope="col" class="text-nowrap">NISN</th>
