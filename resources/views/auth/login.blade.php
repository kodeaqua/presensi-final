                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <p class="card-text mb-2">{{ __('Silakan masuk untuk melanjutkan') }}</p>
                            <form class="auth-login-form mt-2" action="{{ route('login') }}" method="POST">
                                @csrf
                                <div class="mb-1">
                                    <label class="form-label" for="email">{{ __('Email') }}</label>
                                    <input class="form-control @error('email') is-invalid @enderror" id="email"
                                        type="email" name="email" placeholder="guru@domain.com"
                                        value="{{ old('email') }}" required autocomplete="email" autofocus
                                        tabindex="1" aria-describedby="email" />
                                    @error('email')
                                ...
                                <button class="btn btn-primary w-100" tabindex="3">{{ __('Masuk') }}</button>
                            </form>
